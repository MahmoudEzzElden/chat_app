                              ...
                              child: Consumer<GenderProvider>(
                                builder: (context, provider, child) {
                                  return DropdownButton(
                                    ...
                                    onChanged: (newGender) {
                                      provider.selectedGender(newGender as String);
                                    },
                              ...
                              children: [
                                ...
                                CircleAvatar(
                                  ...
                                  child: IconButton(
                                      color: Colors.white,
                                      onPressed: () async{
                                        if (formKey.currentState!.validate() && Provider
                                            .of<TermsProvider>(context, listen: false)
                                            .checkBox == true) {

                                          await FireBaseService.register(
                                              context, emailController.text.trim(),
                                              passwordController.text.trim(),
                                              userName.text.trim(), age.text.trim(),
                                              Provider
                                                  .of<GenderProvider>(
